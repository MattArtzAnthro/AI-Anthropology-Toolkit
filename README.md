...
| [Google Search Questions Explorer](notebooks/Google_Search_Questions_Explorer.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MattArtzAnthro/AI-Anthropology-Toolkit/blob/main/notebooks/Google_Search_Questions_Explorer.ipynb) | Map the public question landscape around any topic using Google Autocomplete data — what, why, how questions plus alphabet expansion |
| [Google Patents Explorer](notebooks/Google_Patents_Explorer.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MattArtzAnthro/AI-Anthropology-Toolkit/blob/main/notebooks/Google_Patents_Explorer.ipynb) | Search Google Patents for patent metadata — titles, inventors, assignees, filing dates, and PDF links for innovation research |
| [Text Network Analysis](notebooks/Text_Network_Analysis.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MattArtzAnthro/AI-Anthropology-Toolkit/blob/main/notebooks/Text_Network_Analysis.ipynb) | Transform text into network graphs — co-occurrence networks, community detection, centrality metrics, and interactive visualization for discourse analysis |
| [YouTube Video Search](notebooks/YouTube_Video_Search.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MattArtzAnthro/AI-Anthropology-Toolkit/blob/main/notebooks/YouTube_Video_Search.ipynb) | Search YouTube and export video metadata — titles, channels, views, durations, and URLs for media research |
